...
object Valuation {
    ...
    // Spec I §4.1: deutsche Beschriftungen (gespeichert bleiben die Codes). ZWILLING: valuation.js, Fixture copies/copy-row.json.
    val EDITION_LABELS = mapOf("first" to "1. Auflage", "unlimited" to "Unlimitiert", "limited" to "Limitiert", "unknown" to "Auflage unbekannt")
