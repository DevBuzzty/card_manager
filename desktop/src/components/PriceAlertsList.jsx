...
export default function PriceAlertsList({ events }) {
  ...
  return (
    <div>
      {failed && <div className="text-klein text-bad mb-1">Erledigen fehlgeschlagen.</div>}
        ...
        {events.map((e) => (
          <div key={e.id} className="flex items-center gap-3 py-2">
            <button type="button"
              ...
              <span className="font-mono text-klein text-muted shrink-0">{fmtDayDE(String(e.day))}</span>
